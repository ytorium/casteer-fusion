...
arg_model = "sdxl-turbo-new"
arg_steer_vectors = "/content/drive/My Drive/casteer_vectors"

# Saving steering vectors:
if not os.path.exists(args.steer_vectors):
    os.makedirs(args.steer_vectors)

with open(os.path.join(arg_steer_vectors, '{}_{}.pickle'.format(arg_model, args.mode)), 'wb') as handle:
